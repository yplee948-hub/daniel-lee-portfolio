  ...
  return (
    <footer className="px-6 md:px-10 pt-16 pb-14">
      <div className="max-w-6xl mx-auto">
        <p
          className={`text-xl md:text-2xl font-sans font-semibold leading-snug max-w-3xl ${subtitle ? "mb-1" : "mb-12"}`}
        >
          Open to PM roles for summer/fall Internships 2026 let&apos;s talk! if you&apos;re
          job-seeking.
        </p>
        {subtitle && (
          <p className="font-body text-body text-neutral-500 mb-12">{subtitle}</p>
        )}
