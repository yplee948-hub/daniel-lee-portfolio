  ...
  return (
    <>
      ...
      <section className="px-6 md:px-16 py-24 bg-neutral-50">
        ...
        <p className="font-body text-body text-neutral-500 leading-relaxed max-w-5xl mb-4">
        ...
        <p className="font-body text-body text-neutral-500 leading-relaxed max-w-5xl mb-12">
