...
export default function HomePage() {
  return (
    <>
      {/* Nav */}
      <nav className="fixed top-0 left-0 right-0 z-50 flex justify-center items-center gap-10 py-4 text-[18px] tracking-widest uppercase text-neutral-400 bg-white/80 backdrop-blur-sm">
